...
export default defineConfig({
  ...
  // Two pages: the app and the session dashboard, which ships too (rudimeter.com/dashboard/, behind the token).
  build: { rollupOptions: { input: { main: here('index.html'), dashboard: here('dashboard/index.html') } } },
})
